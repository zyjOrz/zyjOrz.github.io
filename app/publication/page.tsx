...
export default function PublicationPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#fff3f7] via-[#ffe8f0] to-[#fce6ee] px-6 py-10 font-sans text-[#23161b]">
      <div className="mx-auto max-w-6xl">
        <a
          href="/#publications"
          className="mb-10 inline-flex items-center gap-2 rounded-full border border-[#e2bfd0] bg-white/60 px-4 py-2 text-sm font-medium text-[#7b4456] shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:bg-white/80"
        >
          <ArrowLeft size={16} />
          Back to Home
        </a>

        <section className="rounded-[32px] border border-[#ebd2df] bg-white/65 px-6 py-8 shadow-[0_16px_44px_rgba(178,109,143,0.12)] backdrop-blur-sm sm:px-10 sm:py-12">
          <div className="mb-10">
          ...
          <div className="space-y-10">
            {publications.map((paper) => (
              <article
                key={paper.title}
                className="grid grid-cols-1 gap-7 rounded-[28px] border border-[#eed4de] bg-[#fffafc]/80 p-5 shadow-[0_10px_30px_rgba(191,113,142,0.12)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(191,113,142,0.18)] md:grid-cols-[420px_1fr] md:p-6"
              >
                <div className="group/image relative overflow-hidden rounded-[22px] border border-[#ead5dd] bg-white shadow-[0_10px_26px_rgba(178,109,143,0.14)] transition-all duration-300 ease-out hover:-translate-y-3 hover:shadow-[0_22px_45px_rgba(191,113,142,0.24)]">
